...
export type TelemetryEvent =
  ...
  | "project.concept_enhance_images"
  ...
  | "project.opening_frame_rejected"
  | "project.opening_frame_unpinned"
  | "face_swap.applied"
  | "face_swap.pass"
  | "face_swap.manual"
  | "face_swap.reverted"
  ...
  | "character.created"
  | "settings.generation_defaults_saved"
  | "settings.generation_defaults_loras_unchecked"
  | "character.updated"
  | "character.deleted"
