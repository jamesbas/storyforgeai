...
asked to keep every head inside the frame, faces unobstructed, background players
included. Heads rather than whole bodies: requiring head-to-feet would forbid
every close-up the storyboard is entitled to ask for. A scene with **Face in
frame** cleared is exempt, being framed without a face on purpose.
